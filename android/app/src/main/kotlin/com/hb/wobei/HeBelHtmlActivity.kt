...
class HeBeiHtmlActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionBar?.hide()
        setContentView(R.layout.activity_html_hebei)
    ...
    private fun initWebView() {
        ...
        webView.layoutParams = (FrameLayout.LayoutParams(-1, -1)
                .apply { setMargins(0, DensityUtils.dip2px(this@HeBeiHtmlActivity, 44f), 0, 0) })
        //有效果
...
//                busPost { msg.w(MsgWhat.STOP_PROGRESS) }
    ...
    companion object {
        ...
        fun start(ctx: Context, webUrl: String) {
            ctx.startActivity(Intent(ctx, HeBeiHtmlActivity::class.java).putExtra(WEB_URL, webUrl))
        }
    }
