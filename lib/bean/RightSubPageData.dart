class RightSubPageData {
    ...
    RightSubPageData({this.isEnd, this.pageNum, this.pageSize, this.results, this.totalCount, this.totalPageNum});

    factory RightSubPageData.fromJson(Map<String, dynamic> json) {
        return RightSubPageData(
            isEnd: json['isEnd'],
