...
class _AppState extends BaseState<MePage>
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                      child: Image.asset(
                        ...
                        Navigator.of(context).pushNamed(AppRoute.MESSAGE_CENTER_PAGE);
                      }),
                      top: 10 + getStatusBarHeight(),
                      right: 20,
                    ),
                    ...
                    Positioned(
                      child: getBlackboardRightText().setGestureDetector(
                        onTap: (){
                          goToBuyVipPage();
                        }
                      ),
...
//                    )
                ...
                Row(
                  children: <Widget>[
                    Column(
                      ...
                      Navigator.of(context).pushNamed(AppRoute.RIGHT_EXCHANGE_PAGE, arguments: false);
                    }).setExpanded(1),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: <Widget>[
                      ...
                      Navigator.of(context).pushNamed(AppRoute.RED_PACKET_PAGE, arguments: false);
                    }).setExpanded(1),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                      child: Text(
                        ...
                        Navigator.of(context)
                            .pushNamed(AppRoute.MY_CARD_TICKET_PAGE, arguments: false);
                      }),
                      right: 32,
                      bottom: 11.5,
                    ),
          ...
          Container(
            ...
            child: Stack(
              children: <Widget>[
                Container(
                  child: Text('我的', style: TextStyle(color: Config.BLACK_303133, fontSize: 20),),
                  alignment: Alignment.center,
                  margin: EdgeInsets.only(top: getStatusBarHeight()),
                ),
                Positioned(
                  child: Image.asset(
                    Config.SETTINGS_DARK,
                    width: 24,
                    height: 24,
                    fit: BoxFit.cover,
                  ).setGestureDetector(onTap: () {
            ...
            return Row(
              children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget>[
                    CachedNetworkImage(
                      imageUrl : cardList[index].logo,
                      width: (context.getSrnW() - 52) / 2,
                      height: 121,
                      fit: BoxFit.cover,
                      placeholder: (context, url) => Image.asset(Config.COVER_120_90, width:(context.getSrnW()-52)/2, height: 121, fit: BoxFit.cover,),
                      errorWidget: (context, url, error) =>
                          Image.asset(Config.COVER_120_90, width:(context.getSrnW()-52)/2, height: 121, fit: BoxFit.cover,),
                    ).setClipRRect(4.0),
                    SizedBox(
                      height: 10,
                    ),
                    Text(
                      cardList[index].itemName.maxLength(10),
                      style:
                  ...
                  Navigator.of(context)
                      .pushNamed(AppRoute.CARD_TICKET_DETAIL_PAGE, arguments: cardList[index].id);
                }),
                SizedBox(
  ...
  Widget getEnterprisePrefecture() {
    if (haveEnterprisePrefecture) {
      return Container(
        ...
        Navigator.of(context).pushNamed(AppRoute.ENTERPRISE_PREFECTURE_PAGE, arguments: Pair(first: enterpriseName, second: enterpriseId));
      });
    } else {
      return SizedBox(
        height: 27,
