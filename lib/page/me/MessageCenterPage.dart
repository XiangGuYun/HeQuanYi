          ...
          TabBarView(
            ...
            children: <Widget>[
              Container(
                child: Stack(
                  children: <Widget>[
                    getPushNotificationList(listPush, true),
                    getEmptyPage('暂无推送', visible: listPush.length == 0)
                  ],
                ),
              ),
              Container(
                child: Stack(
                  children: <Widget>[
                    getPushNotificationList(listNotification, false),
                    getEmptyPage('暂无通知', visible: listNotification.length == 0)
                  ],
                ),
              )
            ],
