...
///
///********************************************************************************************
class MyHistoryCardTicketPage extends StatefulWidget {
  @override
  _MyHistoryCardTicketPageState createState() =>
      _MyHistoryCardTicketPageState();
}

class _MyHistoryCardTicketPageState extends BaseState<MyHistoryCardTicketPage> {
                        ...
                        child: Column(
                          ...
                          onTap: () {
                            Navigator.of(context).pushNamed(
                                AppRoute.CARD_TICKET_DETAIL_PAGE,
                                arguments: list[i].id);
                          },
            ...
            TitleBar(
              ...
              subTitleClick: () {
                Navigator.of(context)
                    .pushNamed(AppRoute.MY_CARD_TICKET_PAGE, arguments: true);
              },
            )
          ],
        ),
