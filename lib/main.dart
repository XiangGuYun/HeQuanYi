...
import 'my_lib/base/BaseState.dart';
...
class MainApp extends StatelessWidget {
  //配置路由
  var routes = {
    AppRoute.MY_HISTORY_CARD_TICKET_PAGE: (context) => MyHistoryCardTicketPage(),
    ...
    AppRoute.MY_CARD_TICKET_PAGE: (context, {arguments}) => MyCardTicketPage(isOverdue: arguments,),
    ...
    AppRoute.ENTERPRISE_PREFECTURE_PAGE: (context, {arguments}) =>
        EnterprisePrefecturePage(info: arguments,),
